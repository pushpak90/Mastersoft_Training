...
namespace web
{
    class Program
    {
        ...
        int gper, groll;
        void input(int nroll, string nname, string ncity = "Nagpur",  string nstate, string ncol, string nmob, string nbranch , string nsub)
        {
            groll = nroll;
            gcity = ncity;
            gname = nname;
        ...
        static void Main(string[] args)
        {
            ...
            p1.input(roll, name, city, state, college, mobile, branch, sub);
            p1.grade(per);
